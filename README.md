...
**lucidia metaverse** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
Complete 3D metaverse platform for lucidia.earth with Three.js, physics, multiplayer support, and WebXR
